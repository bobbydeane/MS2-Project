...
let ContentLoaded = document.addEventListener("DOMContentLoaded", function(){
    displayBeginning();
 ...
 */
 ...
 function displayBeginning() {
    ...
    let welcome = document.getElementById("image-area").innerHTML=`<p id="typewriter">Welcome to 8Bit Russian Roulette.<br><br>Select Solo for a single player game,<br><br>
   ...
   let buttonHTML = document.getElementById("buttons").innerHTML= `<button  id="solo" data-type="solo">Solo</button>
    ...
    let solo1 = document.getElementById("solo").onclick = displayRound1Solo;
    let startOnclick = document.getElementById("start").onclick = displayRound1;
    let Vs = document.getElementById("start").innerHTML = `Vs`;
    let buttonstyle = document.getElementById("buttons").style.left = "27%";
    let chamberHTML = document.getElementById("chamber").innerHTML ="";
...
function displayRound1() {
    ...
    let gunGif = document.getElementById("image-area").innerHTML = `<img id="gun" alt="a animated drawing of a hand holding a gun with green background" src="assets/images/RRStillImage.gif">`;
    ...
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1()">1</button>
    ...
    let buttonHTML = document.getElementById("buttons").innerHTML= `
    <button  id="start" data-type="start">Random</button>
    <button id="help" data-type="help" onclick="help()">Help</button>
    <button id="reset" data-type="reset" onclick="displayBeginning()">Reset</button>`;

    let buttonStyle = document.getElementById("buttons").style.left = "33%";
     
    let chamberStyle = document.getElementById("chamber").style.left= "16%";

    let startOnclick = document.getElementById("start").onclick = playRound1;
...
if (num1 === 1) {
    ...
    let startOnclick = document.getElementById("start").onclick = displayRound2;
}
 ...
 */
 ...
 function displayRound2() {
    ...
    /* displays the Gun image */
    let gunGif = document.getElementById("image-area").innerHTML = `<img alt="a animated drawing of a hand holding a gun with green background" id="gun" src="assets/images/RRStillImage.gif">`;
    /* displays the Round 1 text */
    ...
    let startOnclick = document.getElementById("start").onclick = playRound2;
...
if (num1 === 1) {
    ...
    let startOnclick = document.getElementById("start").onclick = displayRound3;
}
 ...
 */
 ...
 function displayRound3() {
     ...
     */
     let chamberStyle = document.getElementById("chamber").style.left ="27%";
    
    let startOnclick = document.getElementById("start").onclick = playRound3;
...
/*displays buttons 1-4*/
let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="">1</button>
<button id="two" data-type="two" input="submit" onclick="">2</button>
<button id="three" data-type="three" input="submit" onclick="">3</button>
 ...
 */
 ...
 function displayRound4() {
    ...
    let chamberHTML = document.getElementById("chamber").innerHTML="";
    let startOnclick = document.getElementById("start").onclick = playRound4;
...
if (num1 === 1) {
    ...
    let startOnclick = document.getElementById("start").onclick = displayRound5;
}
 ...
 */
 ...
 function displayRound5() {
        ...
        let startOnclick = document.getElementById("start").onclick = playRound5;
        console.log(playRound5);
        
        /*displays buttons 1-4*/
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round5()">1</button>
    <button id="two" data-type="two" input="submit" onclick="chamber2Round5()">2</button>
    `;

    let chamberStyle = document.getElementById("chamber").style.left ="38%";
...
if (num1 === 1) {
    ...
    let startOnclick = document.getElementById("start").onclick = displayRound6;
}
}
 ...
 */
 ...
 function displayRound6() {
        ...
        let startOnclick = document.getElementById("start").onclick = playRound6;
...
function help() {
    document.getElementById("image-area").innerHTML= `<p id="typewriter">This is the fun (and safe) arcade version of<br><br>Russian Roullette.<br><br>In round one, the user has a choice between<br>
...
function displayRound1Solo() {
    ...
    let trigger1Text = document.getElementById("start").innerHTML=`<p id="trigger">Random</p>`;
    /*displays buttons 1-6*/
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round1Solo()">1</button>
    ...
    let startOnclick = document.getElementById("start").onclick = playRound1Solo;
...
if (num1 === 1) {
    ...
    let startOnclick = document.getElementById("start").onclick = displayRound2Solo;
}
 ...
 */
 ...
 function displayRound2Solo() {
    ...
    let trigger1Text = document.getElementById("start").innerHTML=`<p id="trigger">Random</p>`;
    /*displays buttons 1-6*/
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round2Solo()">1</button>
    ...
    let startOnclick = document.getElementById("start").onclick = playRound2Solo;
...
if (num1 === 1) {
    ...
    let trigger1Text = document.getElementById("start").innerHTML=`Round 3`;
    let startOnclick = document.getElementById("start").onclick = displayRound3Solo;
}
 ...
 */
 ...
 function displayRound3Solo() {
    ...
    /*displays buttons 1-4*/
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round3Solo()">1</button>
    ...
    let startOnclick = document.getElementById("start").onclick = playRound3Solo;
...
if (num1 === 1) {
    ...
    let trigger1Text = document.getElementById("start").innerHTML=`Round 4`;
    let startOnclick = document.getElementById("start").onclick = displayRound4Solo;
}
 ...
 */
 ...
 function displayRound4Solo() {
    ...
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round4Solo()">1</button>
     ...
     */
     let chamberStyle = document.getElementById("chamber").style.left ="33%";
    
    let startOnclick = document.getElementById("start").onclick = playRound4Solo;
...
if (num1 === 1) {
    ...
    let trigger1Text = document.getElementById("start").innerHTML=`Round 5`;
    let startOnclick = document.getElementById("start").onclick = displayRound5Solo;
}
 ...
 */
 ...
 function displayRound5Solo() {
    ...
    /*displays buttons 1-2*/
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round5Solo()">1</button>
    <button id="two" data-type="two" input="submit" onclick="chamber2Round5Solo()">2</button>`;

    /**
     * Button style - Round 5
     */
     let chamberStyle = document.getElementById("chamber").style.left ="47%";
    
    let startOnclick = document.getElementById("start").onclick = playRound5Solo;
...
if (num1 === 1) {
    ...
    let trigger1Text = document.getElementById("start").innerHTML=`Round 6`;
    let startOnclick = document.getElementById("start").onclick = displayRound6Solo;
}
 ...
 */
 ...
 function displayRound6Solo() {
    ...
    /*displays buttons 1-2*/
    let chamberHTML = document.getElementById("chamber").innerHTML=`<button id="one" data-type="one" input="submit" onclick="chamber1Round6Solo()">Click me</button>`;
    ...
    let startOnclick = document.getElementById("start").onclick = playRound6Solo;
